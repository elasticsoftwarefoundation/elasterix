 ...
 * under the License.
 */
package org.elasticsoftware.sip.ssl;
...
public final class DummySecureSslContextFactory {
    ...
    static {
        ...
        try {
            ...
            ks.load(DummySecureKeyStore.asInputStream(),
                    DummySecureKeyStore.getKeyStorePassword());

            // Set up key manager factory to use our key store
            KeyManagerFactory kmf = KeyManagerFactory.getInstance(algorithm);
            kmf.init(ks, DummySecureKeyStore.getCertificatePassword());
        ...
        try {
            ...
            clientContext.init(null, DummySecureTrustManagerFactory.getTrustManagers(), null);
        } catch (Exception e) {
            throw new Error(
    ...
    private DummySecureSslContextFactory() {
        // Unused
    }
}
