 ...
 */
public class SipResponseNetty extends SipMessageNetty implements SipResponse {
     ...
     */
    public SipResponseNetty(SipVersion version, SipResponseStatus responseStatus) {
        super(version);
