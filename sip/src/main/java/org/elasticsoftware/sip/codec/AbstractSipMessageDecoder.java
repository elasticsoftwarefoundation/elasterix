 ...
 */
public abstract class AbstractSipMessageDecoder extends ReplayingDecoder<AbstractSipMessageDecoder.State> {
	private static final Logger log = Logger.getLogger(AbstractSipMessageDecoder.class);
	...
	/**
	 * The internal state of {@link AbstractSipMessageDecoder}.
	 */
	 ...
	 */
	protected AbstractSipMessageDecoder() {
		this(4096, 8192, 4096);
	}
	 ...
	 */
	protected AbstractSipMessageDecoder(int maxInitialLineLength, int maxHeaderSize,
