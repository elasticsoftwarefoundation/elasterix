...
import org.elasticsoftware.server.messages.SipMessage.SipUser;
...
public class SipMessageTest {
	private static final Logger log = Logger.getLogger(SipMessageTest.class);
	...
	public void testSipUserContact() throws Exception {
		...
		SipUser user = new SipMessage.SipUser(value);
